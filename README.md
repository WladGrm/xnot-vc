...
- папка data:
    - female_voice_domain.flac - файл исходного домена
    - male_voice_domain.flac - файл целевого домена
    - valid.flac - файл для валидации
    - knn-vc** - файлы с результатами алгоритма knn-vc
    - папки Nk содержат примеры с различными параметрами W (N означает количество шагов обучения)
- папка experiments - содержит больше экспериментов и результатов работы модели. Переводим голос спикера 2300 из датасета Librispeech в голоса 10 мужчин и 10 женщин.
